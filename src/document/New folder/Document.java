...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		int numSyllables =0;
		String lastSyllable="";
        for(String s:word.split("[^aeiouyAEIOUY]")){
            if(s!= null && !s.isEmpty() ){
                numSyllables++;
                lastSyllable=s;
        ...
        if(lastSyllable.length()<2 && lastSyllable.equals("e") && numSyllables>1 && (word.substring(word.length()-1).equals("e"))){
            numSyllables--;
        }
        //System.out.println(numSyllables);
	...
	public double getFleschScore()
	{
		...
		double a1 =(1.015)*(getNumWords()/(double)getNumSentences());
		/*System.out.println("**");
		System.out.println(a1);
		System.out.println("@!");
		System.out.println(getNumSyllables());
		System.out.println(getNumWords());*/		
		double a2 =(84.6)*(getNumSyllables()/(double)getNumWords());
		//System.out.println(a2);
		double FleshScore = 206.835-a1 -a2;
	    return FleshScore;
	}
